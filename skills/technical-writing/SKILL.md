...
description: >
  Formal technical-writing standard: Diátaxis structure, Google developer
  style sentences, STE instruction rules, Global English syntax. Use when
  writing or reviewing docs, RFCs, readmes, PR descriptions, or commit
  messages. Composes with the unslop skill, which owns the slop-pattern catalog.
---

<!-- Source: https://github.com/cursor/plugins/blob/main/pstack/skills/technical-writing/SKILL.md, fetched 2026-08-20. Frontmatter adapted: dropped disable-model-invocation so it auto-applies to doc tasks. -->
